const addToShoppingCartButtons = document.querySelectorAll('.product__icon');
        ...
        <div class="col-4">
            <div
                ...
                <input class="shopping-cart-quantity-input shoppingCartItemQuantity" type="number"
                    value="1">
                <button class="btn btn-danger buttonDelete" type="button"><i class="fas fa-times-circle"></i></button>
            </div>
        </div>
    </div>`;
